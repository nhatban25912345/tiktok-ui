...
function ToolTipShareWrapper({ children, positionTopStart }) {
    const [isExtend, setIsExtend] = useState(false);

    console.log(isExtend);

    const handleResetIsExtend = () => {
        setTimeout(() => {
            setIsExtend(false);
        }, 500);
    };
    ...
    return (
        <HeadlessTippy
            placement={positionTopStart ? 'top-start' : 'bottom-end'}
            offset={positionTopStart ? [-50, 282] : [-280, 0]}
            interactive={true}
            delay={[100, 500]}
            zIndex={1}
            render={(attrs) => (
                <div
                    ...
                    tabIndex="-1"
                    {...attrs}
                    onMouseLeave={handleResetIsExtend}
                >
                    ...
                    <div className="flex items-center cursor-pointer mr-[3px] ml-1 px-4 py-[11px] font-semibold hover:bg-[#16182308]">
                        <div className="w-[26px] h-[26px] rounded-full flex justify-center items-center bg-[#25D366] text-white">
                            <ImWhatsapp className="text-sm" />
                        </div>
                        <div className="ms-3">Share to WhatsApp</div>
                    </div>
                    <div className="flex items-center cursor-pointer mr-[3px] ml-1 px-4 py-[11px] font-semibold hover:bg-[#16182308]">
                        <div className="w-[26px] h-[26px] rounded-full flex justify-center items-center bg-[#1DA1F2] text-white">
                            <BsTwitter className="" />
                        </div>
                        <div className="ms-3">Share to Twitter</div>
                    </div>
                    <div className="flex items-center cursor-pointer mr-[3px] ml-1 px-4 py-[11px] font-semibold hover:bg-[#16182308]">
                        <div className="w-[26px] h-[26px] rounded-full flex justify-center items-center bg-[#FE2C55] text-white">
                    ...
                    {isExtend ? (
                        <>
                            <div className="flex items-center cursor-pointer mr-[3px] ml-1 px-4 py-[11px] font-semibold hover:bg-[#16182308]">
                                <div className="w-[26px] h-[26px] rounded-full flex justify-center items-center bg-[#0A66C2] text-white">
                        ...
                        <div
                            className="flex justify-center cursor-pointer mr-[3px] ml-1 px-4 font-semibold hover:bg-[#16182308]"
